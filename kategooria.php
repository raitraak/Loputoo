...
$category = $_GET["id"];
$sql = "SELECT * FROM images WHERE status=1 AND category='$category' ORDER by id DESC";
...
<head>
    ...
    <title><?php echo $category ?> - Pixels</title>
...
<div class="container">
    ...
    <div class="row">
        ...
        echo "<h2 class='h2title'>Kategooria: $category</h2>";
